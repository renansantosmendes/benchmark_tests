...
class WFG(Problem):
    ...
    def _calc_pareto_set(self, n_pareto_points=500, *args, **kwargs):
        ...
        print('pareto points', n_pareto_points)
        print('len(ps)', len(ps))
        print('k', self.k)
        print('diff', n_pareto_points - len(ps))
        # n_pareto_points = len(ps) + 10000
...
class WFG1(WFG):
    ...
    def _calc_pareto_front(self, *args, **kwargs):
        return load_pareto_front_from_file("wfg1-8d.pf")
