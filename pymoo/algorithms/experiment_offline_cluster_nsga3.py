from pymoo.algorithms.offline_cluster_nsga3 import OfflineClusterNSGA3
...
class ExperimentOfflineClusterNSGA3(object):
    ...
    def __init__(self,
        ...
        if use_different_seeds:
            self.algorithms  = [OfflineClusterNSGA3(transformation_matrix=self.transformation_matrix,
                                        ...
                                        cluster=cluster,
                                        method=self.method) for i in range(self.number_of_executions)]
        else:
            self.algorithms  = [OfflineClusterNSGA3(transformation_matrix=self.transformation_matrix,
                                        ref_dirs=self.ref_dirs,
                                        min_max_values=self.min_max_values,
