...
class OnlineNonDominatedGeneticAlgorithm(Algorithm):
    ...
    def _initialize(self):
        ...
        #self.igd_plus = get_performance_indicator("igd+", self.problem.pareto_front())
        # print('pareto front test',self.problem.pareto_front())
    ...
    def apply_cluster_reduction(self):
        if self.current_generation % self.interval_of_aggregations == 0:
            ...
            similarity = 1 - dataframe.corr(method=self.method).values
